...
var _ = (t, r, s) =>
	r in t
		? k(t, r, { enumerable: !0, configurable: !0, writable: !0, value: s })
		: (t[r] = s);
var g = (t, r, s) => _(t, typeof r != "symbol" ? r + "" : r, s),
	u = (t, r, s) => r.has(t) || w("Cannot " + s);
var i = (t, r, s) => (
		u(t, r, "read from private field"),
		s ? s.call(t) : r.get(t)
	),
	b = (t, r, s) =>
		r.has(t)
			...
			: r instanceof WeakSet
				...
				: r.set(t, s),
	c = (t, r, s, e) => (
		u(t, r, "write to private field"),
		e ? e.call(t, s) : r.set(t, s),
		s
	),
	p = (t, r, s) => (u(t, r, "access private method"), s);
import { m as z, L as M } from "./Dbe4PVAU.js";
var o, a, v, h, x;
const f = class f {
	constructor(r) {
		b(this, h);
	...
	observe(r, s) {
		...
		return (
			...
			() => {
				...
				(n.delete(s),
					n.size === 0 && (i(this, o).delete(r), i(this, a).unobserve(r)));
			}
		);
	}
};
