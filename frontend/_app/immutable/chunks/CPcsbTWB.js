...
const Ue = [],
	...
	Ye = (e) => {
		...
		if (t) {
			const c = t + ":",
				m = r;
			r = (a) =>
				a.startsWith(c) ? m(a.slice(c.length)) : ue(Ue, !1, a, void 0, !0);
		}
		if (o) {
			const c = r;
			r = (m) => o({ className: m, parseClassName: c });
		}
		return r;
	},
	qe = (e) => {
			...
			(o) => {
				...
				for (let m = 0; m < o.length; m++) {
					const a = o[m],
						...
						d = t.has(a);
					b || d
						? (c.length > 0 && (c.sort(), r.push(...c), (c = [])), r.push(a))
						: c.push(a);
				}
	...
	xo = () => {
		const e = f("color"),
			...
			l = () => [e, n, s],
			le = () => [...N(), he, ge, { position: [n, s] }],
			ce = () => ["no-repeat", { repeat: ["", "x", "y", "space", "round"] }],
			de = () => ["auto", "cover", "contain", go, mo, { size: [n, s] }],
			ee = () => [re, B, _],
			w = () => ["", "none", "full", u, n, s],
			k = () => ["", p, B, _],
		...
		return {
			...
			classGroups: {
				aspect: [{ aspect: ["auto", "square", C, s, n, x] }],
				container: ["container"],
				...
				z: [{ z: [I, "auto", n, s] }],
				basis: [{ basis: [C, "full", "auto", b, ...i()] }],
				"flex-direction": [
					{ flex: ["row", "row-reverse", "col", "col-reverse"] },
				],
				"flex-wrap": [{ flex: ["nowrap", "wrap", "wrap-reverse"] }],
				flex: [{ flex: [p, C, "auto", "initial", "none", s] }],
				grow: [{ grow: ["", p, n, s] }],
				shrink: [{ shrink: ["", p, n, s] }],
				...
				"max-w": [
					{ "max-w": [b, "screen", "none", "prose", { screen: [a] }, ...G()] },
				],
				h: [{ h: ["screen", "lh", ...G()] }],
				"min-h": [{ "min-h": ["screen", "lh", "none", ...G()] }],
				"max-h": [{ "max-h": ["screen", "lh", ...G()] }],
				"font-size": [{ text: ["base", o, B, _] }],
				"font-smoothing": ["antialiased", "subpixel-antialiased"],
				"font-style": ["italic", "not-italic"],
				"font-weight": [{ font: [r, wo, po] }],
				"font-stretch": [
					{
						"font-stretch": [
							"ultra-condensed",
				...
				tracking: [{ tracking: [c, n, s] }],
				"line-clamp": [{ "line-clamp": [p, "none", n, fe] }],
				leading: [{ leading: [m, ...i()] }],
				...
				"drop-shadow": [{ "drop-shadow": ["", "none", T, H, J] }],
				...
				ease: [{ ease: ["linear", "initial", O, n, s] }],
				delay: [{ delay: [p, n, s] }],
				animate: [{ animate: ["none", D, n, s] }],
				backface: [{ backface: ["hidden", "visible"] }],
				perspective: [{ perspective: [A, n, s] }],
