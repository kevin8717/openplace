(function () {
		...
		for (var t = $2(d.m()), e = 0; e < t.length; e++) {
			...
			if (C($, r)) {
				...
				if (n.l) {
					...
					((n = U($, r)),
						u ? ((u = U(d, r)) ? n1(u, n) : h(d, r, n.clone())) : h(d, r, n));
			}
		}
	}
	...
	((D.prototype.g = function (d) {
		...
		(D.prototype.h = function (d, $) {
			if (d.h == 11 || d.h == 10)
				return $ instanceof a ? $ : this.g(d.s.prototype.m(), $);
			if (d.h == 14)
	...
	function F(d, $) {
		for (var t = new g(), e, n = d.length, r = 0; r < n; ++r)
	...
	function x(d, $, t) {
		return t == "001" ? A(d, "" + $) : A(d, t);
	}
	function w(d) {
		if (!C(d, 2)) return "";
		var $ = "" + f(d, 2);
		return C(d, 4) && f(d, 4) && 0 < l(d, 8)
	...
	function M1(d, $) {
		if (((d = A(d, $)), d == null)) throw Error("Invalid region code: " + $);
		return l(d, 10);
	}
	function H(d, $, t, e) {
		var n = Z(t, e),
			r = M(n, 9) == 0 ? p(f(t, 1), 9) : p(n, 9);
		if (((n = p(n, 10)), e == 2))
			if (m1(Z(t, 0)))
				((d = Z(t, 1)),
					m1(d) &&
						((r = r.concat(M(d, 9) == 0 ? p(f(t, 1), 9) : p(d, 9))),
						r.sort(),
						n.length == 0
							? (n = p(d, 10))
							: ((n = n.concat(p(d, 10))), n.sort())));
			else return H(d, $, t, 1);
		return r[0] == -1
			? 5
			: (($ = $.length),
	...
	function I1(d, $) {
		...
		for (var t, e = d.length, n = 1; 3 >= n && n <= e; ++n)
			if (((t = parseInt(d.substring(0, n), 10)), t in B))
	...
	function A1(d, $, t, e, n, r) {
		...
		if (i.length == 0) u = 20;
			...
			if (((i = new RegExp(u)), C1($), (u = $.toString()), u.search(i) == 0)) {
				...
				o && o[1] != null && 0 < o[1].length && F(o[1], X) == "0"
					? (u = !1)
					: (m($), $.g(u.substring(i)), (u = !0));
			} else u = !1;
			u = u ? 5 : 20;
		}
		if ((n && h(r, 6, u), u != 20)) {
			if (2 >= $.h.length) throw Error("Phone number too short after IDD");
			if (((d = I1($, e)), d != 0)) return (h(r, 1, d), d);
		...
		return t != null &&
			...
			(o = $.toString()),
			o.lastIndexOf(i, 0) == 0 &&
				((i = new g(o.substring(i.length))),
				(o = f(t, 1)),
				(o = new RegExp(l(o, 2))),
				N1(i, t, null),
				(i = i.toString()),
				(!T(o, $.toString()) && T(o, i)) || H(d, $.toString(), t, -1) == 3))
			? (e.g(i), n && h(r, 6, 10), h(r, 1, u), u)
			: (h(r, 1, 0), 0);
	}
	function N1(d, $, t) {
		var e = d.toString(),
	...
	function v1(d, $, t, e) {
		...
		if (
			...
			!u ||
				...
				(r = n.toString()),
				(u = r.indexOf(";isub=")),
				0 < u && (m(n), n.g(r.substring(0, u))),
				!p1(n.toString())))
		)
			throw Error("The string supplied did not seem to be a phone number");
		if (
			((r = n.toString()), !(V(t) || (r != null && 0 < r.length && O.test(r))))
		)
			throw Error("Invalid country calling code");
		((r = new I()), e && h(r, 5, $));
		d: {
			if (
				...
				i = $.match(c1);
				for (var o = i.length, y = 1; y < o; ++y)
					if (i[y] != null && 0 < i[y].length) {
		...
		if (
			...
			2 > $.h.length ||
				(u != null &&
					...
					(n = new g($.toString())),
					N1(n, u, t),
					(d = H(d, n.toString(), u, -1)),
					d != 2 &&
						d != 4 &&
						d != 5 &&
						(($ = n), e && 0 < t.toString().length && h(r, 7, t.toString()))),
				(e = $.toString()),
				(d = e.length),
				2 > d))
		)
	...
	function L1(d, $) {
		var t = d.ga;
		return (($ = V($) ? M1(t, $) : 0), (d = A(d.ga, P($))), d ?? R1);
	}
	function _1(d) {
		for (var $ = d.j.length, t = 0; t < $; ++t) {
			...
			if (
				(y.length < o.g.h.length
					? (o = "")
					: ((o = y.replace(new RegExp(i, "g"), u)),
					...
					: 0 < d.j.length
						? (($ = D1(d, $)),
							...
							0 < t.length
								? t
								: (B1(d, d.g.toString()),
									_1(d) ? w1(d) : d.u ? Y(d, $) : d.s.toString()))
						: z(d);
		}
	}
	function O1(d) {
	...
	function z(d) {
		...
		if (3 <= $.length) {
			for (
				var t =
						d.ca && d.o.length == 0 && 0 < M(d.l, 20) ? p(d.l, 20) : p(d.l, 19),
					e = t.length,
					n = 0;
				n < e;
				++n
				...
				var r = t[n];
				(0 < d.o.length && S1(l(r, 4)) && !f(r, 6) && !C(r, 5)) ||
			...
			return (
				B1(d, $),
				($ = x1(d)),
				0 < $.length ? $ : _1(d) ? w1(d) : d.s.toString()
			);
		}
		return Y(d, $);
	}
	...
	function K1(d) {
		...
		return t == 0
			...
			: (m(d.g),
				d.g.g($.toString()),
				($ = P(t)),
				$ == "001" ? (d.l = A(d.ga, "" + t)) : $ != d.ka && (d.l = L1(d, $)),
				d.h.g("" + t).g(" "),
				(d.o = ""),
				!0);
	}
	...
	(S("intlTelInputUtilsTemp", {}),
		S("intlTelInputUtilsTemp.formatNumberAsYouType", (d, $) => {
			try {
		...
		S("intlTelInputUtilsTemp.numberFormat", {
			E164: 0,
			INTERNATIONAL: 1,
			NATIONAL: 2,
			RFC3966: 3,
		}),
		S("intlTelInputUtilsTemp.numberType", k),
		S("intlTelInputUtilsTemp.validationError", {
			IS_POSSIBLE: 0,
